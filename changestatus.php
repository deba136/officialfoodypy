...
<br><br><br><br><br><br>
   <div class="container">
    <form method="post">
	  ...
	  <div class="col-sm-6">Update Order Status</div>
	  <div class="col-sm-6"><input type="radio"  name="status" value="Delivered">Delivered&nbsp;&nbsp;&nbsp;<input type="radio"  name="status" value="Food Ready">Food Ready&nbsp;&nbsp;&nbsp;<input type="radio"  name="status" value="Out Of Stock">Out Of Stock&nbsp;&nbsp;&nbsp;<input type="radio"  name="status" value="Picked">Picked&nbsp;&nbsp;&nbsp;&nbsp;<input type="radio"  name="status" value="Cancelled By Restaurant ">Cancel Order<br>
	  <br>
