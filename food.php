...
<!--tab 1 ends-->	   
			         ...
			         <!--add Product-->
                        <form action="" method="post" enctype="multipart/form-data">
	                                ...
	                                <div class="form-group">
                                         <input type="file" accept="image/*" name="food_pic" required/>Food Images
                                    </div>
			...
			<!--tab 2 ends-->
			 ...
			 <div class="tab-pane fade" id="accountsettings" role="tabpanel" aria-labelledby="accountsettings-tab">
				...
				?>
                    ...
                    <div class="form-group" id="form-responsive">
			...
			<div class="tab-pane fade" id="logo" role="tabpanel" aria-labelledby="logo-tab">
			 ...
			 <div class="tab-pane fade " id="status" role="tabpanel" aria-labelledby="status-tab">
	            <table class="table" id="tableResponsive">
				<tbody>
				<th>Order Id</th>
				...
				if(mysqli_num_rows($orderquery))
				{
					while($orderrow=mysqli_fetch_array($orderquery))
					{
						...
						<td><?php echo $orderrow['fldstatus']; ?></td>
						<?php
			   if($stat=="Cancelled" || $stat=="Out Of Stock" || $stat== "Food Ready" || $stat== "Picked" || $stat== "Cancelled By Restaurant")
			   {
			   ?>
